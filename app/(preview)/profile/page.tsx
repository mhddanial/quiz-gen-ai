            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  ...
                  <span className="text-lg font-bold text-blue-600">{userStats.totalQuizzes}</span>
                </div>
                
                <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <Settings className="h-5 w-5 text-purple-600" />
                    <span className="text-sm font-medium">Questions Created</span>
                  </div>
                  <span className="text-lg font-bold text-purple-600">{userStats.totalQuestions}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  ...
                  <span className="text-sm font-medium text-green-600">{userStats.lastActivity}</span>
                </div>
              </CardContent>
            </Card>
